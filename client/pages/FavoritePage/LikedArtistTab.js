...
export default function LikedArtistTab() {
  ...
  const addToLikedArtists = async (artistId) => {
    fetch(
      `https://c432-2405-4802-a632-dc60-bdf2-dcb0-6216-5931.ngrok-free.app/auth/${user._id}/addLikedArtists`,
      {
        method: "PATCH",
        headers: {
  ...
  const unlikeArtist = async (artistId) => {
    fetch(
      `https://c432-2405-4802-a632-dc60-bdf2-dcb0-6216-5931.ngrok-free.app/auth/${user._id}/unlikeArtists`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
