...
const PublicPlaylist = () => {
  ...
  useEffect(() => {
    const fetchPublicPlaylists = async () => {
      try {
        const response = await fetch(
          "https://c432-2405-4802-a632-dc60-bdf2-dcb0-6216-5931.ngrok-free.app/playlists/public",
          {
            method: "GET",
            headers: {
    ...
    const fetchLikedPlaylists = async () => {
      try {
        const response = await fetch(
          `https://c432-2405-4802-a632-dc60-bdf2-dcb0-6216-5931.ngrok-free.app/playlists/liked/${user._id}`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleLikeUnlike = async (playlistId) => {
    try {
      const response = await fetch(
        `https://c432-2405-4802-a632-dc60-bdf2-dcb0-6216-5931.ngrok-free.app/playlists/liked/${playlistId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  useEffect(() => {
    const fetchCoinBalance = async () => {
      try {
        ...
        const response = await fetch(
          `https://c432-2405-4802-a632-dc60-bdf2-dcb0-6216-5931.ngrok-free.app/auth/${userId}/coins`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
