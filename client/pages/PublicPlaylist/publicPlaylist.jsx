...
const PublicPlaylist = () => {
  ...
  useEffect(() => {
    const fetchPublicPlaylists = async () => {
      try {
        const response = await fetch(
          "https://3268-1-53-10-45.ngrok-free.app/playlists/public",
          {
            method: "GET",
            headers: {
    ...
    const fetchLikedPlaylists = async () => {
      try {
        const response = await fetch(
          `https://3268-1-53-10-45.ngrok-free.app/playlists/liked/${user._id}`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleLikeUnlike = async (playlistId) => {
    try {
      const response = await fetch(
        `https://3268-1-53-10-45.ngrok-free.app/playlists/liked/${playlistId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  useEffect(() => {
    const fetchCoinBalance = async () => {
      try {
        ...
        const response = await fetch(
          `https://3268-1-53-10-45.ngrok-free.app/auth/${userId}/coins`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
