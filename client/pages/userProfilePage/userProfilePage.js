...
export default function UserPage() {
  ...
  //     // const url2 = `https://c17d-2405-4802-a632-dc60-9df3-e7d9-e18e-caf7.ngrok-free.app/auth/${endpoint}`;
  ...
  //       method: method,
  //       url: `https://c17d-2405-4802-a632-dc60-9df3-e7d9-e18e-caf7.ngrok-free.app/auth/${endpoint}`,
  //       data: data,
  //       headers: {
  ...
  const makeAuthenticatedRequest = async (method, endpoint, data) => {
    try {
      ...
      const response = await axios({
        ...
        url: `https://c17d-2405-4802-a632-dc60-9df3-e7d9-e18e-caf7.ngrok-free.app/auth/${user._id}/${endpoint}`,
        data: data,
        headers: {
  ...
  const submitNameChange = async () => {
    try {
      ...
      await axios({
        method: "PATCH",
        url: `https://c17d-2405-4802-a632-dc60-9df3-e7d9-e18e-caf7.ngrok-free.app/auth/${user._id}/name`,
        data: { name },
        headers: {
  ...
  const handleSendReport = async (feedback) => {
    try {
      ...
      const response = await axios.patch(
        `https://c17d-2405-4802-a632-dc60-9df3-e7d9-e18e-caf7.ngrok-free.app/report/${user._id}/addReport`,
        {
          content: feedback,
          email: user.email,
        }
