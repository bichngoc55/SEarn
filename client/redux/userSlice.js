  ...
  async (currentAccessToken, { rejectWithValue, dispatch }) => {
    try {
      ...
      const response = await fetch(
        "https://c432-2405-4802-a632-dc60-bdf2-dcb0-6216-5931.ngrok-free.app/auth/refresh",
        {
          method: "POST",
          headers: {
...
export const loginUser = createAsyncThunk(
  ...
  async (credentials, { rejectWithValue }) => {
    try {
      ...
      const response = await fetch(
        "https://c432-2405-4802-a632-dc60-bdf2-dcb0-6216-5931.ngrok-free.app/auth/login",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
